  ...
  switch (phase) {
    ...
    case PHASE.CONNECTING:
      return {
        ...
        hint: "Идёт обмен сетевыми данными WebRTC. Сбор ICE — до 8 с (до 20 с без srflx/relay). При failed гость может выдать обновлённый ответ. При проблемах — «Сбросить сессию».",
      };
    case PHASE.CHAT:
      return {
        title: "Чат открыт",
